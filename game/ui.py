...
class Gui:
    ...
    def show_end(self, player_color, score1, score2):
        ...
        if player_color == WHITE:
            self.menu2.add_label("White player wins!", align=pygame_menu.locals.ALIGN_CENTER, font_size=50,
                                 font_width=5, font_color=self.WHITE)
        elif player_color == BLACK:
            self.menu2.add_label("Black player wins!", align=pygame_menu.locals.ALIGN_CENTER, font_size=50,
                                 font_width=5, font_color=self.BLACK)
        else:
            self.menu2.add_label("Tie !", align=pygame_menu.locals.ALIGN_CENTER, font_size=50, font_width=5,
